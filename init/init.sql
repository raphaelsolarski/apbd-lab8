...
INSERT INTO Client (FirstName, LastName, Email, Telephone, Pesel) VALUES ('John', 'Doe', 'john@example.com', '123123123', '123123123');
INSERT INTO Client (FirstName, LastName, Email, Telephone, Pesel) VALUES ('John2', 'Doe2', 'john@example.com', '123123123', '123123123');

INSERT INTO Trip (Name, Description, DateFrom, DateTo, MaxPeople) VALUES ('someTrip', 'someTripDesc', getdate(), getdate(), 20)
INSERT INTO Trip (Name, Description, DateFrom, DateTo, MaxPeople) VALUES ('someTrip2', 'someTripDesc2', getdate(), getdate(), 20)
INSERT INTO Trip (Name, Description, DateFrom, DateTo, MaxPeople) VALUES ('someTrip3', 'someTripDesc3', getdate(), getdate(), 20)

INSERT INTO Client_Trip (IdClient, IdTrip, RegisteredAt, PaymentDate) VALUES (1, 1, getdate(), getdate());
